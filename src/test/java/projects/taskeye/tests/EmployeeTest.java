...
public class EmployeeTest extends TestBase {
    ...
    public void testCreateEmployeeSuccessfully() throws Exception {
        ...
        employeePage.createEmployeeUser()
                ...
                .verifyTheCreatedAndDeleteEmployee();
    }

    @Test
    public void testCreateEditDeleteEmployeeSuccessfully() throws Exception {
        driver.get(getWebsiteUrl());
        initializePages();
        loginToApplication();
        navigateToEmployeeSettings();
        employeePage.createEmployeeUser()
                ...
                .saveButtonOfEmployee()
                .searchEmployeeUser()
                .clickOnCreatedEmployeeUser()
                .editEmployeeDetails()
                .editAddressDetails()
                .editLeaveDetails()
                .saveButtonOfEmployee()
                .verifyThatCompanyDetailsAreEdited()
                .searchEditedEmployeeUser()
                .clickOnEditedEmployeeUser()
                .deleteEmployeeUser()
                .verifyEmployeeUserIsDeleted();

    }

    @Test
    public void testCreateEmployeeWithValidationMessages() throws Exception {
        driver.get(getWebsiteUrl());
        initializePages();
        loginToApplication();
        navigateToEmployeeSettings();
        employeePage.createEmployeeUser()
                .fillEmployeeDetailsWithValidation()
                .saveButtonOfEmployee()
                .verifyTheCreatedAndDeleteEmployee();
    }
