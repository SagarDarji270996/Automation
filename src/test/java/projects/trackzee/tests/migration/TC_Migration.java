package projects.trackzee.tests.migration;
...
public class TC_Migration extends TestBase implements InitializePages {
	String excelFileName = "Migration";
	String sheetName = "Sheet1";
	int totalRecordsColumnIndex = 1;
	...
	@BeforeClass()
	public void selectProjectAndNavigateToScreen() throws InterruptedException {
		System.setProperty("headless", "true");
		getHomePage().selectProject("Netstar FleetAI");
		getHomePage().navigateToScreen(Arrays.asList("Settings", "General", "Company Subuser"));
	}
...
//		getCommonPage().writeDataInExcelSheetWithMultipleEntriesInSingleColumn("Migration", "Sheet1", columnData);
//	}
...
//				.add(excpectedTotalRecords.equalsIgnoreCase(totalRecords) ? "Pass" : "Fail");
	...
	public void excelFileWriter3() throws IOException, InterruptedException {
		getCommonPage().writeDataInExcelSheetWithMultipleEntriesInMultipleColumnsBasedOnGivenRows("Migration",
				"Sheet1", rowIndexes3,
				columnData3);
	}
