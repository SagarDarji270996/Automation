...
public class TC_ContryWiseTravel extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Country Wise Travel");
		System.setProperty("pageTitleAtHeaderBar", "Country Wise Travel");
		System.setProperty("globalSearchValue", "Country Wise Travel");

		System.setProperty("pageName", "CountryWiseTravel");
		System.setProperty("sheetName", "CountryWiseTravel");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Country Wise Travel"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "CountryWiseTravel"/*this is sheetname*/, testName = "CountryWiseTravel" /*This is page page*/)
