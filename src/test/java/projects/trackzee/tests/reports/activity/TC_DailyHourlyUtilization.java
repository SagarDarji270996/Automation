...
public class TC_DailyHourlyUtilization extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Daily - Hourly Utilization");
		System.setProperty("pageTitleAtHeaderBar", "Daily - Hourly Utilization");
		System.setProperty("globalSearchValue", "Daily - Hourly Utilization");

		System.setProperty("pageName", "DailyHourlyUtilization");
		System.setProperty("sheetName", "DailyHourlyUtilization");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Daily - Hourly Utilization"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "DailyHourlyUtilization"/*this is sheetname*/, testName = "DailyHourlyUtilization" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class)
