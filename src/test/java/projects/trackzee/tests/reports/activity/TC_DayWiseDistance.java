...
public class TC_DayWiseDistance extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Daywise Distance");
		System.setProperty("pageTitleAtHeaderBar", "Daywise Distance");
		System.setProperty("globalSearchValue", "Daywise Distance");

		System.setProperty("pageName", "DaywiseDistance");
		System.setProperty("sheetName", "DaywiseDistance");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Daywise Distance"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "DaywiseDistance"/*this is sheetname*/, testName = "DaywiseDistance" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "DaywiseDistance", /*this is sheetname*/ testName = "DaywiseDistance"/*This is page page*/)
