...
public class TC_DaywiseWorkHour extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Daywise Work Hour");
		System.setProperty("pageTitleAtHeaderBar", "Daywise Work Hour");
		System.setProperty("globalSearchValue", "Daywise Work Hour");

		System.setProperty("pageName", "DaywiseWorkHour");
		System.setProperty("sheetName", "DaywiseWorkHour");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Daywise Work Hour"));
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "DaywiseWorkHour"/*this is sheetname*/, testName = "DaywiseWorkHour" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "DaywiseWorkHour", /*this is sheetname*/ testName = "DaywiseWorkHour"/*This is page page*/)
