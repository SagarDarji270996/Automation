...
public class TC_Idle extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Idle");
		System.setProperty("pageTitleAtHeaderBar", "Idle Summary");
		System.setProperty("globalSearchValue", "Idle");

		System.setProperty("pageName", "Idle");
		System.setProperty("sheetName", "Idle");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Idle"));
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "Idle"/*this is sheetname*/, testName = "Idle" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "Idle", /*this is sheetname*/ testName = "Idle"/*This is page page*/)
