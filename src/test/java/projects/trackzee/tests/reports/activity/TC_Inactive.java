...
public class TC_Inactive extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Inactive");
		System.setProperty("pageTitleAtHeaderBar", "Inactive Summary");

		System.setProperty("globalSearchValue", "Inactive");

		System.setProperty("pageName", "Inactive");
		System.setProperty("sheetName", "Inactive");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Inactive"));
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "Inactive"/*this is sheetname*/, testName = "Inactive" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "Inactive", /*this is sheetname*/ testName = "Inactive"/*This is page page*/)
