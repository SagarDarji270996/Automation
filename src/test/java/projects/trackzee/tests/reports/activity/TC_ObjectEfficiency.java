...
public class TC_ObjectEfficiency extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Vehicle Efficiency");
		System.setProperty("pageTitleAtHeaderBar", "Vehicle Efficiency Report");
		System.setProperty("globalSearchValue", "Vehicle Efficiency");

		System.setProperty("pageName", "VehilceEfficiency");
		System.setProperty("sheetName", "ObjectEfficiency");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Vehicle Efficiency"));
		getCommonPage().checkPageLoadingOnDefault(10);
		TestBase.getSoftAssert().assertAll();
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectEfficiency"/*this is sheetname*/, testName = "ObjectEfficiency" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "ObjectEfficiency", /*this is sheetname*/ testName = "ObjectEfficiency"/*This is page page*/)
