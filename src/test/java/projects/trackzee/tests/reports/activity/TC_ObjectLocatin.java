...
public class TC_ObjectLocatin extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Vehicle Location");
		System.setProperty("pageTitleAtHeaderBar", "Vehicle Location Status");
		System.setProperty("globalSearchValue", "Vehicle Location");

		System.setProperty("pageName", "VehicleLocation");
		System.setProperty("sheetName", "ObjectLocation");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Vehicle Location"));
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectLocation"/*this is sheetname*/, testName = "ObjectLocation" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "ObjectLocation", /*this is sheetname*/ testName = "ObjectLocation"/*This is page page*/)
