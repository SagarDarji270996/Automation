...
public class TC_ObjectLocationDurationWise extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Object Location Duration Wise");
		System.setProperty("pageTitleAtHeaderBar", "Object Location Duration Wise");
		System.setProperty("globalSearchValue", "Object Location Duration Wise");

		System.setProperty("pageName", "ObjectLocationDurationWise");
		System.setProperty("sheetName", "ObjectLocationDurationWise");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Object Location Duration Wise"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectLocationDurationWise"/*this is sheetname*/, testName = "ObjectLocationDurationWise" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "ObjectLocationDurationWise", /*this is sheetname*/ testName = "ObjectLocationDurationWise"/*This is page page*/)
