...
public class TC_ObjectNotes extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Object Notes");
		System.setProperty("pageTitleAtHeaderBar", "Object Notes");
		System.setProperty("globalSearchValue", "Object Notes");

		System.setProperty("pageName", "ObjectNotes");
		System.setProperty("sheetName", "ObjectNotes");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Object Notes"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectNotes"/*this is sheetname*/, testName = "ObjectNotes" /*This is page page*/)
