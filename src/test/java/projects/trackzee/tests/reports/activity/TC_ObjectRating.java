...
public class TC_ObjectRating extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Object Rating");
		System.setProperty("pageTitleAtHeaderBar", "Object Rating");
		System.setProperty("globalSearchValue", "Object Rating");

		System.setProperty("pageName", "ObjectRating");
		System.setProperty("sheetName", "ObjectRating");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Object Rating"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectRating"/*
																																					 * this
																																					 * is
																																					 * sheetname
																																					 */, testName = "ObjectRating" /*
																																													 * This
																																													 * is
																																													 * page
																																													 * page
	...
	public void testToCompareTwoSummaryWithDetailsReportAsPDF() throws Exception {
		// TESTCASE_DONE: Check the travel summary with details report when downloaded
		// as pdf
