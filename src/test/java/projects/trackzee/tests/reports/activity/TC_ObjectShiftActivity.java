...
public class TC_ObjectShiftActivity extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Object Shift Activity");
		System.setProperty("pageTitleAtHeaderBar", "Object Shift Activity");
		System.setProperty("globalSearchValue", "Object Shift Activity");

		System.setProperty("pageName", "ObjectShiftActivity");
		System.setProperty("sheetName", "ObjectShiftActivity");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Object Shift Activity"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectShiftActivity"/*this is sheetname*/, testName = "ObjectShiftActivity" /*This is page page*/)
