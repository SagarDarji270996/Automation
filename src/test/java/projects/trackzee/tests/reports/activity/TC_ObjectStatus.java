...
public class TC_ObjectStatus extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Object Status");
		System.setProperty("pageTitleAtHeaderBar", "Object Status");

		System.setProperty("globalSearchValue", "Object Status");

		System.setProperty("pageName", "ObjectStatus");
		System.setProperty("sheetName", "ObjectStatus");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Object Status"));
	...
	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectStatus"/*this is sheetname*/, testName = "ObjectStatus" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "ObjectStatus", /*this is sheetname*/ testName = "ObjectStatus"/*This is page page*/)
