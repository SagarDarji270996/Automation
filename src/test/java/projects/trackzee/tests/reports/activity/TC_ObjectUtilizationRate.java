...
public class TC_ObjectUtilizationRate extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Object Utilization Rate");
		System.setProperty("pageTitleAtHeaderBar", "Object Utilization Rate");
		System.setProperty("globalSearchValue", "Object Utilization Rate");

		System.setProperty("pageName", "ObjectUtilizationRate");
		System.setProperty("sheetName", "ObjectUtilizationRate");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Object Utilization Rate"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectUtilizationRate"/*this is sheetname*/, testName = "ObjectUtilizationRate" /*This is page page*/)
