...
public class TC_ObjectViolation extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Object Violation");
		System.setProperty("pageTitleAtHeaderBar", "Object Violation");
		System.setProperty("globalSearchValue", "Object Violation");

		System.setProperty("pageName", "ObjectViolation");
		System.setProperty("sheetName", "ObjectViolation");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Object Violation"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "ObjectViolation"/*this is sheetname*/, testName = "ObjectViolation" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "ObjectViolation", /*this is sheetname*/ testName = "ObjectViolation"/*This is page page*/)
