...
public class TC_SpeedVsDistance extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Speed vs Distance");
		System.setProperty("pageTitleAtHeaderBar", "Speed vs Distance");

		System.setProperty("globalSearchValue", "Speed vs Distance");

		System.setProperty("pageName", "SpeedVsDistance");
		System.setProperty("sheetName", "SpeedVsDistance");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Speed vs Distance"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "SpeedVsDistance"/*this is sheetname*/, testName = "SpeedVsDistance" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "SpeedVsDistance", /*this is sheetname*/ testName = "SpeedVsDistance"/*This is page page*/)
