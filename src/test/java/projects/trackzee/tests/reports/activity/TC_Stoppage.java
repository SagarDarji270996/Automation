...
public class TC_Stoppage extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Stoppage");
		System.setProperty("pageTitleAtHeaderBar", "Stoppage Summary");

		System.setProperty("globalSearchValue", "Stoppage");

		System.setProperty("pageName", "Stoppage");
		System.setProperty("sheetName", "Stoppage");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Stoppage"));
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "stoppage"/*this is sheetname*/, testName = "stoppage" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "Stoppage", /*this is sheetname*/ testName = "Stoppage"/*This is page page*/)
