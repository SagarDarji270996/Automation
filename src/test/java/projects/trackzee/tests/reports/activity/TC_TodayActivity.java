...
public class TC_TodayActivity extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Today Activity"));
	...
	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "TodayActivity"/*this is sheetname*/, testName = "TodayActivity" /*This is page page*/)
