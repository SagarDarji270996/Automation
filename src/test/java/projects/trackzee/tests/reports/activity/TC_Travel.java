...
public class TC_Travel extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Travel");
		System.setProperty("pageTitleAtHeaderBar", "Travel Summary");

		System.setProperty("globalSearchValue", "Travel");

		System.setProperty("pageName", "Travel Summary");
		System.setProperty("sheetName", "Travel");
	...
	@Test(enabled = true, priority = 2, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "Travel"/*this is sheetname*/, testName = "Travel" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "Travel", /*this is sheetname*/ testName = "Travel"/*This is page page*/)
