...
public class TC_TravelHistory extends TestBase implements InitializePages {
	...
	String mostRecentDownloadFile = "Travel History";
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Travel History");
		System.setProperty("pageTitleAtHeaderBar", "Travel History");

		System.setProperty("globalSearchValue", "Travel History");

		System.setProperty("pageName", "TravelHistory");
		System.setProperty("sheetName", "TravelHistory");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Travel History"));
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "travelHistory"/*this is sheetname*/, testName = "travelHistory" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "TravelHistory", /*this is sheetname*/ testName = "TravelHistory"/*This is page page*/)
