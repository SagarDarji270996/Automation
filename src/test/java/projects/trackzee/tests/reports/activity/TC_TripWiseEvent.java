...
public class TC_TripWiseEvent extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Trip Wise Event");
		System.setProperty("pageTitleAtHeaderBar", "Trip Wise Event");
		System.setProperty("globalSearchValue", "Trip Wise Event");

		System.setProperty("pageName", "TripWiseEvent");
		System.setProperty("sheetName", "TripWiseEvent");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Trip Wise Event"));
		getCommonPage().checkPageLoadingOnDefault(10);
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "TripWiseEvent"/*this is sheetname*/, testName = "TripWiseEvent" /*This is page page*/)
