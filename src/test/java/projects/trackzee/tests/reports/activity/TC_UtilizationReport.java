...
public class TC_UtilizationReport extends TestBase implements InitializePages {
	...
	public void selectProjectAndNavigateToTravelSummaryReports() throws InterruptedException {
		...
		System.setProperty("deepModule", "Utilization Report");
		System.setProperty("pageTitleAtHeaderBar", "Utilization Report");

		System.setProperty("globalSearchValue", "Utilization Report");

		System.setProperty("pageName", "UtilizationReport");
		System.setProperty("sheetName", "UtilizationReport");

		getHomePage().selectProject("Trakzee Premium");
		getHomePage().navigateToScreen(Arrays.asList("Reports", "Activity", "Utilization Report"));
	}

	@Test(enabled = true, dataProvider = "filterDataProviderForActivitySubModule", dataProviderClass = TC_Filter.class, description = "UtilizationReport"/*this is sheetname*/, testName = "UtilizationReport" /*This is page page*/)
	...
	@Test(enabled = true, priority = 1, dataProvider = "scheduleReportDataProviderForActivitySubModule", dataProviderClass = TC_ScheduleReport.class, description = "UtilizationReport", /*this is sheetname*/ testName = "UtilizationReport"/*This is page page*/)
